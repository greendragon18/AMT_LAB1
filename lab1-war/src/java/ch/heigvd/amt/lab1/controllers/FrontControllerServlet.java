...
import ch.heigvd.amt.lab1.services.MeasureService;
...
public class FrontControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("measures", measuresManager.getMeasures());
        request.getRequestDispatcher("WEB-INF/view/measures.jsp").forward(request, response);
    }
